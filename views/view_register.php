...
<!--
  function doChallengeResponse() {
    ...
    if (pwnh1 == pwnh2)
    { 
        str1 = document.getElementById("email").value.toLowerCase()+"*"+document.getElementById("passwordnothashed1").value;
                            ...
                            <div class="form-group">
                              <div class="col-md-12">
                                <ul class="list-inline pull-right">
                                    <li>
                                        <a class="btn btn-default" href="<?php echo url(array('controller' => 'site', 'view' => 'home'))?>"><?php t(':CANCEL') ?></a>
                                    </li>
                                    <li>
                                        <input class="btn btn-primary" onClick="doChallengeResponse();" type="submit" name="submitbtn" value="<?php t(':REGISTER') ?>" />
                                    </li>
                                </ul>
                              </div>
                            </div>
